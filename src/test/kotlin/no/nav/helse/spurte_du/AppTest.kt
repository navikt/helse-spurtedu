...
class AppTest {
    ...
    @Test
    fun `unauthenticated - create secret`() =
        spurteDuE2E {
            client
                .post("/skjul_meg") {
    ...
    @Test
    fun `unauthenticated - access to public value`() =
        spurteDuE2E {
    ...
    @Test
    fun `authenticated - access to public value`() =
        spurteDuE2E {
    ...
    @Test
    fun `unauthenticated - no access to private value`() =
        spurteDuE2E {
    ...
    private data class ExpectedTextResponse(
        val text: String,
    )
