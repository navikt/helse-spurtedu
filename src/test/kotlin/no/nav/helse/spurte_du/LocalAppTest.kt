...
class LokalBruker(
    ...
    companion object {
        fun List<LokalBruker>.håndterAutentisering(
        ...
        private fun List<LokalBruker>.somPrinsipal(
            logg: Logg,
            bruker: String,
        ): SpurteDuPrinsipal? {
...
class LokalePrinsipaler(
    private val logg: Logg,
    private val lokaleBrukere: List<LokalBruker>,
) {
    fun håndterAutentisering(
        logg: Logg,
        context: AuthenticationContext,
    ) {
...
class LokaleMaskeringer(
    lokaleMaskeringer: List<MaskertVerdi>,
